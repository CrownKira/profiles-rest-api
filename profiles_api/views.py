...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    # will invoke has_object_permission in these classes
    # these are object permission checkers
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    # use this token authentication to authenticate request to our endpoint
    # add this so that request has the user associated to the authenticated user
    authentication_classes = (TokenAuthentication,)
    # used to validate, etc
    ...
    # life cycle method
    # customize the behavior for creating obj thru model viewset
    # perform_create gets called everytime we do http post to our viewset
    # serializer.save() used to save the content of the serializer (data) to the db
